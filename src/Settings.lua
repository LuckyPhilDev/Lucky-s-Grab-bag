...
function LuckyGrabbag.Settings:Init(db, charDB)
    ...
    local function questShoppingToggles(g)
        ...
        g:Toggle({
            ...
            image     = canBuy and "auction-house/quest-item-search"
                or "auction-house/quest-item-find",
            imageSize = canBuy and { 477, 198 } or { 377, 183 },
            since     = "1.24.0",
            onToggle  = function(checked)
    ...
    do
        ...
        g:Toggle({
            label    = SS.decorVendorPreview.label,
            desc     = SS.decorVendorPreview.desc,
            checked  = db.decorVendorPreview,
            since    = "1.27.0",
            onToggle = function(checked)
                db.decorVendorPreview = checked

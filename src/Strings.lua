...
LuckyGrabbag.Strings = LuckyStrings.New("LuckyGrabbag.Strings", {
    ...
    settings = {
        ...
        questShoppingAutoBuy = {
            ...
            desc  = "Skips the price check. The first item is bought the moment the Auction House prices it, with no second click and no chance to look at the total first.",
        },
        testflightBuy = {
        ...
        combatPrep = {
            ...
            desc  = "Pull timer and ready check buttons while you are in a group in a dungeon, or leading or assisting a raid. Shows out of combat. Right-click drag to move.",
        },

...
- **Manual Mode** The Bank Queue can open on a Start button instead, so nothing moves to or from your Warband Bank until you press it. Warband Stockist's choice applies to both addons when it is installed. (Thanks for the suggestion Halliday)

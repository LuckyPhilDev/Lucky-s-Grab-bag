...
### Trading Post Animations
Remembers your **Combat Animation** and **Mount Special** checkbox choices while browsing the Trading Post, including after closing the window or logging back in. Choices are shared across your characters. Enabled by default; toggle it under **Interface > Trading Post** in the addon settings.
...
- **Auto Accept profession quests** takes the quest as soon as its giver offers it.
- **Auto Hand in profession quests** hands one back the moment you have what it asked for.
...
- *Dundun Finder*: Shows a button in bountiful delves that targets, pings and marks Dundun.
